  ...
  return (
    <div className="px-4 py-10">
      <div className="mb-8">
        ...
        <div className="py-3 border-t border-b flex items-center space-x-3 cursor-pointer">
        ...
        <div className="mt-5">
          ...
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1 bg-orange-500 hover:bg-orange-600 text-white py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 font-medium focus:ring-orange-500">Talk to seller</button>
