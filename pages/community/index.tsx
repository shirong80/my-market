    ...
    <div className="py-16 px-4 space-y-8">
			{[1,2,3,4,5].map((_, i) => (
				<div key={i} className="flex flex-col cursor-pointer items-start">
					...
					<div className="mt-2 text-tray-700">
			...
			<button className="fixed bottom-24 right-5 bg-orange-400 hover:bg-orange-500 cursor-pointer rounded-full shadow-xl p-4 text-white transition-colors">
        <svg
          className="w-6 h-6"
          fill="none"
          stroke="currentColor"
